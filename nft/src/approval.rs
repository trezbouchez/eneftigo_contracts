...
impl NonFungibleTokenCore for Contract {
    ...
    fn nft_approve(&mut self, token_id: TokenId, account_id: AccountId, msg: Option<String>) {
        ...
        assert_eq!(
            ...
            &token.owner_id,
            "Approval-granting party must own the token."
        );
        ...
        let is_new_approval = token
            ...
            .insert(account_id.clone(), approval_id)    // insert returns none if the key was not present.  
            .is_none();

        // calculate storage used to add the account.
        ...
        // insert the token back into the collection
    ...
    fn nft_revoke(&mut self, token_id: TokenId, account_id: AccountId) {
        ...
        if token
            ...
            .is_some()
        {
            // refund for the storage used by approved account
